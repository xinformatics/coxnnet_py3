...
#saveModel(model, 'PBA_cindex_'+str(round(cindex_val,3))+'.pkl')
### model save works
...
#feaimp = permutationImportance(model, 1, x_train, ytime_train, ystatus_train) # 1 time flip

feaimp = permutationImportance(model, 10, x_train, ytime_train, ystatus_train)
